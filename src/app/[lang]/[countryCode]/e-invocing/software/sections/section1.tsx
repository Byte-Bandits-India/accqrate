...
const Section1 = () => {
    ...
    return (
        <>
            <section className='overflow-x-hidden'>
                <div className='bg-[#eff3ff]'>
                    <FadeUp className="mb-8 md:mb-[40px] pt-12">
                        <h1 className="text-[23px] md:text-[24px]  leading-[36px] font-bold text-[#1c2041] text-center mx-auto mt-6">
                            <T>Trusted by</T>{" "}
                    ...
                    <div className="px-6 md:px-8 xl:px-0 max-w-[1200px] mx-auto xl:flex items-end justify-between gap-20">
                        ...
                        <FadeUp className="flex-1">
                            <h1 className="text-[23px] md:text-[24px] font-bold pt-[30px] md:pt-[37px] text-[#1c2041] text-center leading-[36px]">
                                <T>Customize and send invoices easily</T>
                            </h1>
                            <p className="text-[16px] text-center mt-2 text-[#5A6183] leading-[28px">
                ...
                flex flex-col gap-2 px-6"
                                            >
                                                <div className='flex'>
                                                    ...
                                                    <div className="flex justify-start items-center mb-2 md:mb-4 gap-4">
                                                        <div className="w-[40px]">
                                                            <Image
                                                                src={feature.img}
                                                                alt={feature.title}
                                                                className="w-full max-h-[35px] h-auto object-contain"
                                                                unoptimized
                                                                width={550}
                                                                height={400}
                                                            />
                                                ...
                                                {/* Title + Description */}
                                                <div className="mb-3 space-y-2 md:space-y-4 flex-grow">
                                                    <div>
                                                        <h2 className="text-[16px] md:text-[18px] font-bold text-[#1c2041] leading-[28px] mb-1">
                                                            <T>{feature.title}</T>
                                                        </h2>
                                                        {feature.sub && (
                                                            <h2 className="text-[16px] md:text-[18px] font-bold text-[#1c2041] leading-[28px]">
                                                                <T>{feature.sub}</T>
                                                            </h2>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div>
                                                        <p className="text-[#5a6183] text-[14px] leading-[25px]">
                    ...
                    <div className="relative pb-10 md:pb-12 mt-10">
                                    ...
                                    <div className="">
                                        <Reveal direction='right'>
                                            ...
                                            <>
                                                ...
                                                <p className='text-[20px] font-medium mt-6 text-[#1c2041] text-left leading-[32px]'>
                                                    <T>{pageContent.headingDescription}</T>
                                                </p>
                                                <p className="text-[16px] font-normal mt-2 text-[#5a6183] text-left leading-[28px]">
                                                    <Image
                                                        src={AssetPath.resources.greenTick.src}
                                                        alt="icon"
                                                        className="inline-block w-7 h-7 mr-1 -mt-1 align-text-top"
                                                        unoptimized
                                                        width={28}
                                                        height={28}
                                                    />
                                                ...
                                                <div className="bg-white rounded-2xl shadow p-6 mt-6 md:mt-10 w-full max-w-[410px]">
                                                    <div className="flex flex-col h-full">
                                                        ...
                                                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 flex-1 min-h-0">
                                                            <p className="text-[14px] text-[#5a6183] leading-[28px] flex-1 overflow-hidden line-clamp-3">
            ...
            transition-shadow duration-300 w-full lg:max-w-[360px]
            ...
            ${index === 0
                                                ? 'w-full  lg:w-[calc(33.333%-21.33px)]'
                                                : index < 3
                                                    ? 'w-full  lg:w-[calc(33.333%-21.33px)]'
                                                    : 'w-full   lg:w-[calc(33.333%-21.33px)]'
                                            }
            ...
            `}
                                        ...
                                        <div className="relative z-10 flex flex-col h-full">
                                            <div className="flex-shrink-0 mb-2 md:mb-3">
                                                ...
                                                <h3 className="text-[#303030] font-bold text-[16px] md:text-[18px] leading-[28px] break-words">
                                                    <T>{card.title}</T>
                                                </h3>

                                                {card.subTitle && (
                                                    <h3 className="text-[#303030] font-bold text-[16px] md:text-[18px] mb-2 md:mb-3 leading-[28px] break-words">
                                                        <T>{card.subTitle}</T>
                                                    </h3>
                                                )}
                                            </div>
                                            ...
                                            <div className="flex-grow overflow-hidden">
                                                {card.description && (
                                                    <p className="text-[#5A6183] text-[16px] leading-[28px] break-words mb-3">
