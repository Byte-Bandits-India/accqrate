            ...
            <div className='bg-[#F1F2FF]'>
                <div className='max-w-[1280px] mx-auto py-8 md:py-10 lg:py-20'>
                    <div className='px-6 md:px-8 xl:px-0'>
                        <FadeUp>
                            <h3 className="text-[24px] font-bold text-[#000000] text-center leading-[36px]">
                                <T>Flexible Deployment</T>
                            </h3>
                            <p className='text-[#333333] text-[16px] text-center mt-2 leading-[28px]'><T>Cloud (managed, subscription) or On‑Prem (full control over infra & data).</T></p>
                            ...
                            <div className="py-6 md:py-8 lg:py-10">
                                <div className="flex flex-col lg:flex-row justify-center items-stretch gap-8 md:gap-10 lg:gap-[60px] md:pl-10">
                                    ...
                                    <div className="rounded-[27px] bg-white border max-w-[400px] w-full p-6 shadow-md md:px-10 space-y-4 flex flex-col">
                                        ...
                                        />
                                        <h3 className="text-[16px] font-bold md:text-[18px] text-[#1C2041]">
                                            <T>Cloud Based Solutions</T>
                                        </h3>
                                        <p className="text-[16px] text-[#5A6183] leading-[35px] max-w-[350px]">
                                        ...
                                        {[
                                                ...
                                                <li key={i} className="flex items-start gap-2">
                                                    <span className="mt-[15px] block w-[6px] h-[6px] rounded-full bg-[#91ABFF]" />
                                    ...
                                    <div className="rounded-[27px] bg-white border max-w-[400px] w-full p-6 shadow-md md:px-10 space-y-4 flex flex-col">
                                        ...
                                        <ul className="text-[#5A6183] text-[16px] leading-[32px] space-y-2 mt-2 list-none">
                                            {[
                            ...
                            <Col xs={24} sm={12} md={6} lg={6} key={i}>
                                ...
                                >
                                    ...
                                    <div className="flex flex-col flex-grow p-4">
                                        <h3 className="text-[18px] leading-[28px] font-semibold text-[#1C2041] line-clamp-2 mb-2">
                                            <T lang={lang} countryCode={countryCode?.toUpperCase()}>{data.heading}</T>
                                        </h3>
                                        <p className="text-[#5A6183] text-sm line-clamp-2 leading-[25px] mb-4">
