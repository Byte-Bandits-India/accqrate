        ...
        <section className={className}>
            <div className="overflow-x-hidden my-8 md:my-10 lg:my-12">
                <div className="max-w-[1280px] mx-auto px-6 md:px-8 xl:px-0 relative">
                    ...
                    <div className="absolute left-32 xl:left-0 top-24 md:top-20 -translate-y-1/2 -translate-x-full">
                    ...
                    <h3
                        className="text-[23px] lg:text-[24px] max-w-[871px] mx-auto text-center font-bold text-[#1c2041] leading-[36px] relative"
                        data-aos="fade-up"
                    >
                        <T lang={lang} countryCode={countryCode}>Our solutions seamlessly integrate with any</T><span className='text-[#1a4ced]'> <T>ERP/POS system</T></span> <T>you use.</T>
                    </h3>
                            ...
                            {integration.concat(integration).map((data, i) => (
                                ...
                                >
                                    <Image
                                        ...
                                        width={150}
                                        height={60}
                                        className="h-[40px] md:h-[50px] w-auto object-contain filter grayscale hover:grayscale-0 transition-transform duration-300 hover:scale-110"
                                    />
                                </div>
                            ))}
                        </div>
