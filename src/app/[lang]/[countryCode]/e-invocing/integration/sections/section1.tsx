        ...
        <section className={className}>
            <div className="overflow-x-hidden my-8 md:my-10 lg:my-12">
                <div className="max-w-[1280px] mx-auto px-6 md:px-8 xl:px-0 relative">
                    ...
                    <h3
                        className="text-fluid-h2 lg:text-[24px] max-w-[871px] mx-auto text-center font-bold text-[#1c2041] leading-tight relative"
                        data-aos="fade-up"
                    >
