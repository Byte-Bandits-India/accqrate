  ...
  return (
    <>
      <section className="mt-8 md:mt-10 lg:mt-12 relative">
        ...
        {/* ================= TALK TO OUR EXPERT (UNCHANGED) ================= */}
        <div className="relative mt-8 md:mt-10 lg:mt-12 h-auto md:h-[480px] overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between max-w-[1200px] mx-auto w-full h-full md:px-8 px-0">
            <div className="relative flex flex-col justify-center items-center md:items-start text-center md:text-left w-full bg-gradient-to-br from-[#1A0C48] to-[#242087] md:bg-none md:w-1/2 z-20 rounded-t-[30px] md:rounded-none px-6 py-10">
