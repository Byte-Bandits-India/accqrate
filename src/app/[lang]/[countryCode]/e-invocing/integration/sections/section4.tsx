    ...
    <section className="py-16 md:py-20 px-6 md:px-8 lg:px-0 bg-[#f7f7ff]">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-10">
          <h2 className="text-[18px] md:text-[24px] font-bold text-[#1C2041]">
          ...
          <p className="text-[#5A6183] text-[14px] md:text-[16px] max-w-[720px] mx-auto mt-4 leading-relaxed">
            ...
            {data.topLeftItems.map((item, i) => (
              <div key={i} className="flex items-start gap-4">
                ...
                <p className="text-[#5A6183] text-[14px] md:text-[16px] leading-relaxed">
                  <span className="font-semibold text-[#1C2041]">
            ...
            {data.bottomRightItems.map((item, i) => (
              <div key={i} className="flex items-start gap-4">
                <Image
                  ...
                  className="mt-1"
                />
                <p className="text-[#1C2041] text-[14px] md:text-[16px] leading-relaxed">
