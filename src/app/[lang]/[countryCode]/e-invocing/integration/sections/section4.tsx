      ...
      <div className="max-w-[1200px] mx-auto">
        <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            {/* RIGHT – IMAGE */}
            <Reveal direction="right" className="flex justify-center items-center my-auto order-1 lg:order-2">
              {data.topRightImage && (
                <Image
                  src={
                    countryCode === "sa"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-20 bg-[#eff3ff] p-6 md:p-8 rounded-[20px]">
            ...
            <div className="space-y-4 flex flex-col justify-center">
              {data.bottomRightItems.map((item, i) => (
                <Reveal direction="right" key={i} className="flex items-start gap-4">
                  <Image
                    src={AssetPath.integration.tick}
                    width={24}
                    height={24}
