...
ma: {
  title: " ",
  subtitle:
    "Integrating your existing application through various formats. Schedule your integration with LHDN.",
  ...
  steps: [
    ...
    },
    {
      number: "Step 3",
      title:
        "Our E-invoicing solution transforms and transmits the data to LHDN",
      description:
        "Our connector interfaces with our API, converting and adapting data for seamless integration and sending it to LHDN.",
      image: AssetPath.invoicing.integrationFlow3.src,
      icon: AssetPath.invoicing.integrationFlowIcon3.src,
    },
    {
      number: "Step 4",
      title: "LHDN approved invoices are given back to your ERP/POS",
      description:
        "LHDN clearances are processed instantly, ensuring swift compliance and operational efficiency.",
      image: AssetPath.invoicing.integrationFlow4.src,
      icon: AssetPath.invoicing.integrationFlowIcon2.src,
    },
    {
...
jd: {
  ...
  steps: [
    ...
    },
    {
      ...
      description:
        "Our connector interfaces with our API, converting and adapting data for seamless integration and sending it to ISTD.",
      image: AssetPath.invoicing.integrationFlow3.src,
      icon: AssetPath.invoicing.integrationFlowIcon3.src,
    },
    {
...
mu: {
  title: " ",
  subtitle:
    "Integrating your existing application through various formats. Schedule your integration with MRA.",
  ...
  steps: [
    ...
    },
    {
      number: "Step 3",
      title:
        "Our E-invoicing solution transforms and transmits the data to MRA",
      description:
        "Our connector interfaces with our API, converting and adapting data for seamless integration and sending it to MRA.",
      image: AssetPath.invoicing.integrationFlow3.src,
      icon: AssetPath.invoicing.integrationFlowIcon3.src,
    },
    {
      number: "Step 4",
      title: "MRA approved invoices are given back to your ERP/POS",
      description:
        "MRA clearances are processed instantly, ensuring swift compliance and operational efficiency.",
      image: AssetPath.invoicing.integrationFlow4.src,
      icon: AssetPath.invoicing.integrationFlowIcon2.src,
    },
    {
