...
ae: {
  ...
  ma: {
    title: "Why Choose ",
    subtitle:
      "Seamlessly integrate your existing ERP/POS with LHDN and become 100% LHDN Phase 2 Compliant.",
    ...
    topLeftItems: [
      ...
      {
        title: "Compliant Templates",
        desc: "Access LHDN-approved custom invoice templates for guaranteed compliance and your brand identity."
      },
      {
        title: "QR Code Integration",
        desc: "Embed QR codes in invoices for easy validation."
      ...
      {
        title: "Mobile Confirmation",
        desc: "Verify QR codes instantly with the LHDN mobile app."
      },
      {
        title: "Automated Communication",
        desc: "Automatically send invoices to buyers via Email & WhatsApp."
    ...
    bottomRightItems: [
      "Integration with LHDN’s Fatoora portal",
      "Automatic Company Onboarding through OTP",
      "E-invoice generation and hashing XML Tax & Simplified invoices",
      "Generate Digital signature",
      "Integrate the LHDN approved QR code",
      "Generate PDF/A3 with integrated XML",
      "Dashboards in the application",
      "Track acceptance/rejections",
      "Take corrective actions with simple clicks",
    ...
    title: "Why Choose ",
    subtitle:
      "Seamlessly integrate your existing ERP/POS with ISTD and become 100% ISTD Compliant.",
    ...
    topLeftItems: [
      ...
      {
        title: "Compliant Templates",
        desc: "Access ISTD-approved custom invoice templates for guaranteed compliance and your brand identity."
      },
      {
        title: "QR Code Integration",
        desc: "Embed QR codes in invoices for easy validation."
      ...
      {
        title: "Mobile Confirmation",
        desc: "Verify QR codes instantly with the ISTD mobile app."
      },
      {
        title: "Automated Communication",
        desc: "Automatically send invoices to buyers via Email & WhatsApp."
    ...
    bottomRightItems: [
      "Integration with ISTD’s Fatoora portal",
      "Automatic Company Onboarding through OTP",
      "E-invoice generation and hashing XML Tax & Simplified invoices",
      "Generate Digital signature",
      "Integrate the ISTD approved QR code",
      "Generate PDF/A3 with integrated XML",
      "Dashboards in the application",
      "Track acceptance/rejections",
      "Take corrective actions with simple clicks",
    ...
    title: "Why Choose ",
    subtitle:
      "Seamlessly integrate your existing ERP/POS with MRA and become 100% MRA Phase 2 Compliant.",
    ...
    topLeftItems: [
      ...
      {
        title: "Compliant Templates",
        desc: "Access MRA-approved custom invoice templates for guaranteed compliance and your brand identity."
      },
      {
        title: "QR Code Integration",
        desc: "Embed QR codes in invoices for easy validation."
      ...
      {
        title: "Mobile Confirmation",
        desc: "Verify QR codes instantly with the MRA mobile app."
      },
      {
        title: "Automated Communication",
        desc: "Automatically send invoices to buyers via Email & WhatsApp."
    ...
    bottomRightItems: [
      "Integration with MRA’s Fatoora portal",
      "Automatic Company Onboarding through OTP",
      "E-invoice generation and hashing XML Tax & Simplified invoices",
      "Generate Digital signature",
      "Integrate the MRA approved QR code",
      "Generate PDF/A3 with integrated XML",
      "Dashboards in the application",
      "Track acceptance/rejections",
      "Take corrective actions with simple clicks",
