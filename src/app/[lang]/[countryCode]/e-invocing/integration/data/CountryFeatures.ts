...
ctaDescription:
  ...
  },
  {
    ...
    features: [
      {
        img: AssetPath.invoicing.integrationAssets.shield.src,
        title: "Fully compliant",
        description:
          "An approved ZATCA solution provider, ensuring 100% audit-proof invoicing.",
      },
      {
        img: AssetPath.invoicing.integrationAssets.certify.src,
...
},
{
 ...
 ma: {
    integrationHeading: "Flexible methods for",
    integrationHighlight: "LHDN",
    integrationDescription:
      "Adaptive approaches for seamless LHDN compliance and integration solutions.",
       featureHeading: "Enhanced",
featureHighlight: "Electronic Invoicing",
featureDescription:
  "Streamline your invoicing with our automated, globally compatible solution featuring advanced security.",
ctaDescription:
  "We provide complete assistance for LHDN e-invoicing integration from onboarding to continuous compliance.",

      sections: [
  {
    img: AssetPath.invoicing.integrationAssets.integration1.src,
    title: "API Based Integrations",
    desc: "Accqrate’s APIs offer unparalleled flexibility, enabling seamless integration of your tax or simplified tax invoices with LHDN, ensuring effortless compliance and connectivity.",
  },
  {
    img: AssetPath.invoicing.integrationAssets.integration2.src,
    title: "FTP/S-FTP Integrations",
    ...
    features: [
      {
        ...
        title: "Fully compliant",
        description:
          "An approved LHDN solution provider, ensuring 100% audit-proof invoicing.",
      },
      {
        img: AssetPath.invoicing.integrationAssets.certify.src,
        title: "Audited & Certified",
        description:
          "Our customers setups right from LHDN wave 1 are 100% audited and certified.",
      },
      {
        img: AssetPath.invoicing.integrationAssets.cloud.src,
        title: "Flexibility in Deployment",
      ...
      },
      {
        img: AssetPath.invoicing.integrationAssets.cal.src,
        title: "Rapid Implementation",
        description: "Go live in just 5 days with guaranteed LHDN integration",
      },
      {
  img: AssetPath.invoicing.integrationAssets.set.src,
  title: "Packaged Solution",
  description:
   ...
   jd: {
    integrationHeading: "Flexible methods for",
    integrationHighlight: "ISTD",
    integrationDescription:
      "Adaptive approaches for seamless ISTD compliance and integration solutions.",
       featureHeading: "Enhanced",
featureHighlight: "Electronic Invoicing",
featureDescription:
  "Streamline your invoicing with our automated, globally compatible solution featuring advanced security.",
ctaDescription:
  "We provide complete assistance for ISTD e-invoicing integration from onboarding to continuous compliance.",

      sections: [
  {
    img: AssetPath.invoicing.integrationAssets.integration1.src,
    title: "API Based Integrations",
    desc: "Accqrate’s APIs offer unparalleled flexibility, enabling seamless integration of your tax or simplified tax invoices with ISTD, ensuring effortless compliance and connectivity.",
  },
  {
    img: AssetPath.invoicing.integrationAssets.integration2.src,
    title: "FTP/S-FTP Integrations",
    ...
    features: [
      {
        ...
        title: "Fully compliant",
        description:
          "An approved ISTD solution provider, ensuring 100% audit-proof invoicing.",
      },
      {
        img: AssetPath.invoicing.integrationAssets.certify.src,
        title: "Audited & Certified",
        description:
          "Our customers setups right from ISTD wave 1 are 100% audited and certified.",
      },
      {
        img: AssetPath.invoicing.integrationAssets.cloud.src,
        title: "Flexibility in Deployment",
      ...
      },
      {
        img: AssetPath.invoicing.integrationAssets.cal.src,
        title: "Rapid Implementation",
        description: "Go live in just 5 days with guaranteed ISTD integration",
      },
      {
  img: AssetPath.invoicing.integrationAssets.set.src,
  title: "Packaged Solution",
  description:
   ...
   mu: {
    integrationHeading: "Flexible methods for",
    integrationHighlight: "MRA",
    integrationDescription:
      "Adaptive approaches for seamless MRA compliance and integration solutions.",
       featureHeading: "Enhanced",
featureHighlight: "Electronic Invoicing",
featureDescription:
  "Streamline your invoicing with our automated, globally compatible solution featuring advanced security.",
ctaDescription:
  "We provide complete assistance for MRA e-invoicing integration from onboarding to continuous compliance.",

      sections: [
  {
    img: AssetPath.invoicing.integrationAssets.integration1.src,
    title: "API Based Integrations",
    desc: "Accqrate’s APIs offer unparalleled flexibility, enabling seamless integration of your tax or simplified tax invoices with MRA, ensuring effortless compliance and connectivity.",
  },
  {
    img: AssetPath.invoicing.integrationAssets.integration2.src,
    title: "FTP/S-FTP Integrations",
    ...
    features: [
      {
        ...
        title: "Fully compliant",
        description:
          "An approved MRA solution provider, ensuring 100% audit-proof invoicing.",
      },
      {
        img: AssetPath.invoicing.integrationAssets.certify.src,
        title: "Audited & Certified",
        description:
          "Our customers setups right from MRA wave 1 are 100% audited and certified.",
      },
      {
        img: AssetPath.invoicing.integrationAssets.cloud.src,
        title: "Flexibility in Deployment",
      ...
      },
      {
        img: AssetPath.invoicing.integrationAssets.cal.src,
        title: "Rapid Implementation",
        description: "Go live in just 5 days with guaranteed MRA integration",
      },
      {
  img: AssetPath.invoicing.integrationAssets.set.src,
  title: "Packaged Solution",
