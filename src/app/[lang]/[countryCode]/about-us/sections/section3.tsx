  ...
  return (
    <section className="overflow-x-hidden w-full bg-white py-24 px-6">
      <div className="max-w-[1177px] mx-auto">
        ...
        {/* Header */}
        <h2 className="text-center text-[20px] md:text-[30px] font-bold mb-4">
          <T lang={lang} countryCode={countryCode?.toUpperCase()}><span className="text-[#1A4CED]">Our</span> Journey</T>
        </h2>

        <p className="text-center text-sm md:text-[16px] text-gray-600 max-w-3xl mx-auto leading-normal">
