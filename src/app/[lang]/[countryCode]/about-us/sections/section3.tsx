              ...
              {content.timeline.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute left-0.5 top-1/2 -translate-y-1/2 md:relative md:left-auto md:top-[30%] md:translate-y-0 flex justify-center md:order-2">
                      <div className="w-5 h-5 bg-[#1c2041] rounded-full z-10" />
                    </div>


                    <div
                      className={`hidden md:flex ${isLeft
                    ...
                    {/* CONTENT */}
                    <div
                      className={`flex-1 ml-6 md:ml-0 md:max-w-[480px] ${isLeft
                        ? "md:pr-6 md:order-1"
                        : "md:pl-6 md:order-3"
                        }`}
                    >
