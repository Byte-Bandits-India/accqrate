...
function OracleInvoicing() {
  return (
    ...
    >
      ...
      <Image src={AssetPath.invoicing.oracle.oracle14} className="w-full  mb-4" alt="integration1" />
      ...
      <Image src={AssetPath.invoicing.oracle.oracle10} className="w-full  mb-4" alt="oracle10" />
      ...
      <Image src={AssetPath.invoicing.oracle.oracle8} className="w-full  mb-4" alt="oracle8" />
      ...
      <Image src={AssetPath.invoicing.oracle.oracle6} className="w-full  mb-4" alt="oracle6" />
      ...
      <Image src={AssetPath.invoicing.oracle.oracle13} className="w-full  mb-4" alt="oracle13" />

      <p className="text-fluid-small leading-relaxed text-gray-700 mb-4">
        <T>Search the order and select the “Fulfillment View”</T>
      </p>

      <Image src={AssetPath.invoicing.oracle.oracle11} className="w-full  mb-4" alt="oracle11" />
      <Image src={AssetPath.invoicing.oracle.oracle4} className="w-full  mb-4" alt="oracle4" />
      <Image src={AssetPath.invoicing.oracle.oracle7} className="w-full  mb-4" alt="oracle7" />
      ...
      <Image src={AssetPath.invoicing.oracle.oracle5} className="w-full  mb-4" alt="oracle5" />

      <p className="text-fluid-small leading-relaxed text-gray-700 mb-4">
        <T>In a few milliseconds, the response (approval or rejection) is received from ZATCA.</T>
      </p>

      <Image src={AssetPath.invoicing.oracle.oracle1} className="w-full  mb-4" alt="oracle1" />
      ...
      <Image src={AssetPath.invoicing.oracle.oracle2} className="w-full  mb-4" alt="oracle2" />
      <p className="text-fluid-small leading-relaxed text-gray-700 mb-4">
      ...
      <Image src={AssetPath.invoicing.oracle.oracle3} className="w-full  mb-4" alt="oracle3" />
      ...
      <Image src={AssetPath.invoicing.oracle.oracle12} className="w-full  mb-4" alt="oracle12" />
      <Image src={AssetPath.invoicing.oracle.oracle9} className="w-full  mb-4" alt="oracle9" />
      <Image src={AssetPath.invoicing.oracle.oracle15} className="w-full  mb-4" alt="oracle15" />
