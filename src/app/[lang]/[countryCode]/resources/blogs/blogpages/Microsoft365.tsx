...
export default function Microsoft365() {
  return (
    ...
    >
      <Image
        src={AssetPath.blogs.zatcaIntegrationMicrosoft}
      ...
      <Image src={AssetPath.microsoft.image1} className="w-full my-3 rounded-md" alt="integration1" />
      <p className="text-fluid-small text-gray-700 leading-relaxed mb-4">
      ...
      {[
        {
          ...
          img: AssetPath.microsoft.image2,
        ...
        },
        {
          ...
          img: AssetPath.microsoft.image3,
        ...
        },
        {
          ...
          img: AssetPath.microsoft.image4,
        ...
        },
        {
          ...
          img: AssetPath.microsoft.image5,
        ...
        },
        {
          ...
          img: AssetPath.microsoft.image6,
        ...
        },
        {
          ...
          img: AssetPath.microsoft.image7,
        ...
        },
        {
          ...
          img: AssetPath.microsoft.image8,
        ...
        },
        {
          ...
          img: AssetPath.microsoft.image10,
        ...
        <div key={idx}>
          ...
          <Image src={step.img} className="w-full my-3 rounded-md" alt={step.title} />
          <p className="text-fluid-small text-gray-700 leading-relaxed mb-4">
            <T>{step.text}</T>
          </p>
        </div>
      ...
      <Image src={AssetPath.microsoft.image9} className="w-full my-4 rounded-md" alt="extra-image" />
