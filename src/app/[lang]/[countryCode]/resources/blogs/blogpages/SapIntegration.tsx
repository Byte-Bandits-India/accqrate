...
function SapIntegration() {
  return (
    ...
    >
      ...
      <div className="story text-fluid-small leading-relaxed">
        <img src={AssetPath.integration.integration1.src} className="w-100 mb-2" alt="integration1" />
        <T>1. An invoice is generated in SAP.</T>

        <img src={AssetPath.integration.integration2.src} className="w-100 mb-2 mt-3" alt="integration2" />
        <T>2. The output message ZINV is configured to invoke specific Z-Programs.</T>

        <img src={AssetPath.integration.integration3.src} className="w-100 mb-2 mt-3" alt="integration3" />
        <T>3. At this stage, invoice printouts lack the QR code or ZATCA ID.</T>

        <img src={AssetPath.integration.integration4.src} className="w-100 mb-2 mt-3" alt="integration4" />
        <T>4. Accqrate’s E-invoicing tracker in SAP provides a complete view of all processed invoices.</T>

        <img src={AssetPath.integration.integration5.src} className="w-100 mb-2 mt-3" alt="integration5" />
        <T>5. A green process indicator signifies ZATCA approval of the invoice.</T>

        <img src={AssetPath.integration.integration6.src} className="w-100 mb-2 mt-3" alt="integration6" />
        <T>6. Clicking on the XML icon displays the ZATCA-approved XML.</T>

        <img src={AssetPath.integration.integration7.src} className="w-100 mb-2 mt-3" alt="integration7" />
        <T>7. Clicking on the PDF icon shows the invoice printout.</T>

        <img src={AssetPath.integration.integration8.src} className="w-100 mb-2 mt-3" alt="integration8" />
        <T>8. Approved invoices feature the QR code, confirming ZATCA endorsement.</T>

        <img src={AssetPath.integration.integration9.src} className="w-100 mb-2 mt-3" alt="integration9" />
        <T>9. Error messages are consolidated and displayed in the error logs.</T>

        <img src={AssetPath.integration.integration10.src} className="w-100 mb-2 mt-3" alt="integration10" />
        <T>10. Users can correct errors and resubmit invoices to ZATCA.</T>

        <img src={AssetPath.integration.integration11.src} className="w-100 mb-2 mt-3" alt="integration11" />
