...
export default function CreditNote() {
  ...
  return (
    ...
    >
      ...
      <Image src={AssetPath.blogs.creditnote1} alt="creditnote1" className="w-full mb-4 rounded-lg shadow" />
      ...
      <Image src={AssetPath.blogs.creditnote2} alt="creditnote2" className="w-full mb-4 rounded-lg shadow" />
