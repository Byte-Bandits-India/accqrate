      ...
      <div className="w-[900px] xl:w-[1100px] mx-auto px-8 pb-10 bg-white rounded-b-xl flex flex-col">
        <div className="grid w-full max-w-7xl mx-auto">
          ...
          <div className="col-span-2 mb-10">
            <h6 className="pl-2.5 font-medium uppercase text-[18px] text-[#333333] mb-4">
              {activeSection}
            </h6>
                    ...
                    >
                      {item.img && (
                        <Image
                          src={item.img}
                          alt={item.title}
                          className="w-[20px] h-[20px] object-contain mt-1"
                          width={20}
                          height={20}
                        />
                      )}
                      ...
                      <div>
                        <h4 className="text-[15px] font-medium text-[#333333] leading-tight hover:text-[#534ED3] ">
                          <T>{item.title}</T>
                        </h4>
                        <p className="text-[14px] text-gray-500 leading-snug mt-[6px] ">
          ...
          <div className="w-full px-6 pt-6 xl:pt-0 md:px-[32px] xl:px-0">
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="hidden md:flex items-center gap-2 shrink-0">
                ...
                <Link
                  href={createHref("/contact-us")}
                  className="hidden px-2 xl:inline-flex items-center leading-tight text-center justify-center gap-2 text-[#F05A28] h-[34px] w-[119px] font-medium rounded-[80px] text-[12px] xl:text-[13px] border border-[#29266E] bg-gradient-to-r from-[#194BED] to-[#29266E] bg-clip-text text-transparent"
                >
                  <T>{contactInfo.salesText}</T>
                </Link>
                <button
                  onClick={() => setModalOpen(true)}
                  className="hidden xl:inline-flex items-center justify-center leading-tight gap-2 text-white h-[34px] font-medium w-[121px] rounded-[80px] text-[12px] xl:text-[13px] bg-gradient-to-r from-[#194BED] to-[#29266E]"
                >
                  <T>Book a Demo</T>
                </button>
              </div>
