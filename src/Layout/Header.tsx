    ...
    sections: [
      {
        ...
        subItems: [
          ...
          },
          {
            ...
            img: AssetPath.header.einvoicing.icons.oracleIcon,
          ...
          },
          {
            ...
            img: AssetPath.header.einvoicing.icons.microsoftIcon,
          ...
          },
          {
            ...
            img: AssetPath.header.einvoicing.icons.legacyIcon,
          ...
          },
          {
            ...
            img: AssetPath.header.einvoicing.icons.homegrownIcon,
          ...
          },
          {
            ...
            img: AssetPath.header.einvoicing.icons.frameworkIcon,
        ...
        subItems: [
          {
            ...
            icon: AssetPath.header.resources.blogIcon,
          },
          {
            title: "Announcements",
            description: "Find answers to common questions",
            href: "/resources/announcement",
            icon: AssetPath.header.resources.announceIcon,
          },
          {
            title: "FAQs",
            description: "Connect with other users",
            href: "/resources/faq",
            icon: AssetPath.header.resources.faqIcon,
          },
          {
            title: "Tax Calculator",
            description: "Calculate your tax obligations",
            href: "/resources/vat",
            icon: AssetPath.header.resources.taxIcon,
          },
          {
            title: "Events",
            description: "Upcoming events and webinars",
            href: "/resources/webinars",
            icon: AssetPath.header.resources.eventIcon,
          },
        ],
      },
    ],
