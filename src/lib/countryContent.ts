...
const defaultContent: CountryContent = {
  ...
  cards: [
    ...
    {
      icon: AssetPath.icons.dataHostedSaudiCloud,
      title: "Data Hosted in Saudi",
...
const mauritiusContent: CountryContent = {
  ...
  cards: [
    ...
    {
      icon: AssetPath.icons.dataHostedSaudiCloud,
      title: "Data Hosted in Mauritius",
      description: "Secure, Transparent, Responsible",
      color: "linear-gradient(to right, #FFFFFF, #D3D1FF)",
      link: "SA/business/books",
    },
...
const polandContent: CountryContent = {
  ...
  complianceSection: {
    ...
    complianceDescription: "Accqrate ensures end-to-end compliance with Poland's B2B e-invoicing mandate and the FPS Finance requirements. Our platform supports:",
    complianceItems: [
