...
"UAE VAT Calculator": {
  ar: "حاسبة ضريبة القيمة المضافة في الإمارات"
},
...
"Value Added Tax (VAT) is an indirect tax levied on most goods and services at each stage of the supply chain, from production to point-of-sale. Implemented in UAE in 2018 at 5%, the rate was adjusted to 15% in July 2020 to address COVID-19 impacts.": {
  ar: "ضريبة القيمة المضافة (VAT) هي ضريبة غير مباشرة تُفرض على معظم السلع والخدمات في كل مرحلة من مراحل سلسلة التوريد، بدءًا من الإنتاج وحتى نقطة البيع. تم تطبيقها في دولة الإمارات العربية المتحدة عام 2018 بنسبة 5٪، وتم تعديل النسبة إلى 15٪ في يوليو 2020 لمعالجة آثار جائحة كوفيد-19."
},
...
"Get Started": {
 ...
 "About Accqrate:": { 
    ...
    "Advancing Digital Compliance & E-Invoicing for the UAE": { 
        ar: "تعزيز الامتثال الرقمي والفوترة الإلكترونية لدولة الإمارات العربية المتحدة" 
    },
    ...
    "Accqrate is a global E-Invoicing and digital compliance platform built to support the UAE's accelerating shift toward structured tax reporting, VAT transparency, and real-time financial governance.": { 
        ar: "أكيوريت هي منصة عالمية للفوترة الإلكترونية والامتثال الرقمي، صُممت لدعم تسارع دولة الإمارات نحو التقارير الضريبية المنظمة، وشفافية ضريبة القيمة المضافة، وحوكمة مالية آنية." 
    },
    ...
    "Built for UAE VAT & FTA Compliance": { 
        ar: "مصمم للامتثال لضريبة القيمة المضافة ومتطلبات الهيئة الاتحادية للضرائب في الإمارات" 
    },
    ...
    "Accqrate delivers a UAE-ready e-invoicing and reporting engine aligned with FTA VAT regulations, audit requirements, and data retention mandates. The platform is designed to support structured invoice data, automated validations, and seamless reporting while remaining future-proof for upcoming real-time or continuous transaction control models.": { 
        ar: "يوفر أكيوريت محرك فوترة إلكترونية وتقارير جاهزاً لدولة الإمارات ومتوافقاً مع لوائح ضريبة القيمة المضافة للهيئة الاتحادية للضرائب ومتطلبات التدقيق وإجراءات حفظ البيانات. وقد صُممت المنصة لدعم البيانات المنظمة للفواتير، والتحقق الآلي، والتقارير السلسة، مع جاهزية كاملة للنماذج المستقبلية للرقابة الفورية أو المستمرة على المعاملات." 
    },

    "Enterprise-Grade Architecture for the GCC": { 
        ar: "هندسة معيارية للمؤسسات في دول مجلس التعاون الخليجي" 
    },
    ...
    "With Swiss-led engineering and large-scale deployments across 30+ industries, Accqrate supports complex, multi-entity organizations operating across the UAE, KSA, and the wider GCC ensuring consistency, governance, and operational control across borders.": { 
        ar: "بفضل الهندسة السويسرية والانتشار الواسع عبر أكثر من 30 قطاعاً، يدعم أكيوريت المؤسسات المعقدة ومتعددة الكيانات العاملة في الإمارات والسعودية ودول مجلس التعاون الخليجي، مع ضمان الاتساق والحوكمة والسيطرة التشغيلية عبر الحدود." 
    },
    ...
    "Accqrate combines automation, AI-driven checks, and standardized integrations to reduce manual effort, minimize compliance risk, and simplify VAT operations for organizations of every size.": { 
        ar: "يجمع أكيوريت بين الأتمتة، والفحوصات المدعومة بالذكاء الاصطناعي، والتكاملات المعيارية لتقليل الجهد اليدوي، وخفض مخاطر عدم الامتثال، وتبسيط عمليات ضريبة القيمة المضافة للمؤسسات بمختلف أحجامها." 
    },
    ...
    "Accqrate eliminates traditional ERP and compliance bottlenecks through rapid integrations, modular scalability, and enterprise-grade reliability allowing organizations to modernize without operational disruption.": { 
        ar: "يقضي أكيوريت على عنق الزجاجة التقليدي في أنظمة الـERP والامتثال، من خلال التكامل السريع، والقابلية العالية للتوسع، والموثوقية على مستوى المؤسسات، مما يسمح للشركات بالتحديث دون تعطيل تشغيلي." 
    },
    ...
    "Expansion and Growth in the UAE": { 
        ar: "التوسع والنمو في الإمارات" 
    },

    // Subtitle
    "Accqrate’s expansion in the UAE represents a strategic milestone in our Middle East compliance roadmap.": { 
        ar: "يمثل توسع أكيوريت في دولة الإمارات محطة استراتيجية في خارطة طريق الامتثال الخاصة بنا في الشرق الأوسط." 
    },

    // Features
    // Feature 1
    "Compliance-Ready Architecture": { 
        ar: "هندسة جاهزة للامتثال" 
    },
    ...
    "Accqrate is engineered to align with UAE VAT laws, FTA audit requirements, and enterprise governance standards-ensuring long-term regulatory readiness.": { 
        ar: "صُمم أكيوريت ليتماشى مع قوانين ضريبة القيمة المضافة الإماراتية، ومتطلبات تدقيق الهيئة الاتحادية للضرائب، ومعايير الحوكمة المؤسسية—مما يضمن جاهزية تنظيمية طويلة الأمد." 
    },

    // Feature 2
    "Rapid Market Adoption": { 
        ar: "اعتماد سريع في السوق" 
    },
    ...
    "From high-growth SMEs to large conglomerates, UAE organizations rely on Accqrate for seamless integration with ERP, POS, and financial systems.": { 
        ar: "تعتمد مؤسسات الإمارات، من الشركات الصغيرة سريعة النمو إلى التكتلات الكبرى، على أكيوريت لتحقيق تكامل سلس مع أنظمة الـERP وPOS والأنظمة المالية." 
    },
    ...
    "Accqrate supports:\n• SMEs seeking a streamlined, compliant invoicing solution\n• Large enterprises requiring multi-entity orchestration, VAT reconciliation, and centralized compliance control": { 
        ar: "يدعم أكيوريت:\n• الشركات الصغيرة والمتوسطة التي تبحث عن حل فوترة متوافق ومبسط\n• المؤسسات الكبرى التي تحتاج إلى تنسيق متعدد الكيانات، وتسوية ضريبة القيمة المضافة، وتحكم مركزي بالامتثال" 
    },
    ...
    "A global team of engineers, tax specialists, and solution architects operates across Switzerland, India, MENA, and Europe. Our UAE and GCC compliance experts bring deep knowledge of VAT regulations, enterprise finance operations, and ERP integrations ensuring every deployment is accurate, predictable, and aligned with FTA requirements.": { 
        ar: "يعمل فريق عالمي من المهندسين والمتخصصين الضريبيين ومهندسي الحلول في سويسرا والهند ومنطقة الشرق الأوسط وشمال أفريقيا وأوروبا. ويقدم خبراؤنا في الامتثال لدولة الإمارات ودول مجلس التعاون معرفة عميقة بلوائح ضريبة القيمة المضافة، وعمليات المالية المؤسسية، وتكاملات الـERP، لضمان تنفيذ دقيق ومتوقع ومتوافق مع متطلبات الهيئة الاتحادية للضرائب." 
    },

    // CTA Section content
    // Title
    "Save time. Reduce risk. Stay compliant.": { 
        ar: "وفّر الوقت. خفّض المخاطر. وابقَ ملتزماً." 
    },

    // Description 1
    "Want the latest updates on UAE VAT regulations, upcoming e-invoicing frameworks, and Accqrate product innovations?": { 
        ar: "هل ترغب في آخر التحديثات حول لوائح ضريبة القيمة المضافة الإماراتية، وأطر الفوترة الإلكترونية القادمة، وابتكارات منتجات أكيوريت؟" 
    },
    ...
    "Got any questions about the product or scaling on our platform? We're here to help. Chat to our friendly team 24/7 and get onboard in less than 5 minutes.": {
        ar: "هل لديك أي أسئلة حول المنتج أو التوسع على منصتنا؟ نحن هنا لمساعدتك. تحدث إلى فريقنا الودود على مدار الساعة، ويمكنك الانضمام في أقل من خمس دقائق."
    },
    ...
    "Call our team Monday - Friday from 9:00 AM to 5:00 PM": {
        ar: "اتصل بفريقنا من الاثنين إلى الجمعة من الساعة 9:00 صباحاً حتى 5:00 مساءً"
    },
    ...
    "Seeking cutting-edge E-invoicing software ready for UAE? Let us find the perfect pricing fit for you.": {
        ar: "هل تبحث عن برنامج فوترة إلكترونية متطور وجاهز للإمارات؟ دعنا نجد لك الخطة السعرية المثالية."
    },
    ...
    "Integrate your ERP with compliance systems": {
        ar: "قم بدمج نظام الـERP الخاص بك مع أنظمة الامتثال"
    },

    "Peppol Ready e-invoing? Our experts have got your back.": {
        ar: "جاهز لفوترة Peppol الإلكترونية؟ خبراؤنا هنا لدعمك."
    },
    ...
    "Become our Trusted Partner": {
        ar: "كن شريكاً موثوقاً لنا"
    },

    "Eager to streamline E-invoicing Compliance in UAE for your clientele and expand your horizons? Let us collaborate.": {
        ar: "هل تتطلع إلى تحسين امتثال الفوترة الإلكترونية لعملائك في الإمارات وتوسيع نطاق عملك؟ دعنا نتعاون."
    },
